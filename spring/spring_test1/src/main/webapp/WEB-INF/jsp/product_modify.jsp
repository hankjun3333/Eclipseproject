...
상품 명 : <input type="text" name="pname" value="${data.get(2)}"><br>
상품 금액 : <input type="text" name="pmoney" value="${data.get(3)}"><br>
상품 이미지 : <img src="${data.get(4)}" style="width:150px;"><br>
할인율 : <input type="text" name="psale" value="${data.get(5)}">%<br>
사용 유무 : 
<input type="radio" name="puse" value="y" ${data.get(6) eq "Y" ? "checked" : ""}>사용
<input type="radio" name="puse" value="n" ${data.get(6) eq "N" ? "checked" : ""}>안사용
<br><br>
