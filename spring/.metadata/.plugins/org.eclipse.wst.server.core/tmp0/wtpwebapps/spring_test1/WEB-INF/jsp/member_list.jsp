...
//배열 값이 null 일 경우 jsp 에서 해당 HTML 코드를 비활성화 시키는 방법!
	...
	//out.print(part); 확인 꼭하자
	
	String s2 = null;
	//null진짜 젤 1순위로 체크해야함 && 앞뒤 순서바뀌어도 에러남
...
<%if(member_data.get(0).get(1) == null ||member_data.get(0).get(3)==null){ %>
<tr>
<td colspan="6">검색한 내용없음</td>
</tr>
<%
}else{
	int w = 0;
...
검색 : <!-- 검색시 분류설정하여 검색되도록함 -->
<select name="part">
<option value="id" selected>아이디</option>
<option value="tel"<%=s2%>>연락처</option>
</select>
<!-- 검색시 분류설정하여 검색되도록함 -->
<input type="text" name="search">
<input type="submit" value="검색">
<input type="button" value="전체목록" onclick="all_data()">
</form>
</body>
